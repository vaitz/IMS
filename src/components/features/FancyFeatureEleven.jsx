  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            ...
            >
              ...
              >
                <img src="/njsw36/static/images/icon/73.svg" alt="icon" />
              </div>
              ...
              <Link to="/solution-management" className="rotate-180">
                <img src="/njsw36/static/images/icon/72.svg" alt="icon" />
              </Link>
            </div>
          </div>
        </div>
        <img
          src="/njsw36/static/images/assets/screen_02.png"
          alt=""
      ...
      <div className="block-style-sixteen" style={{ background: "#EDF3F9" }}>
        <div className="container">
          <div className="row">
            ...
            >
              ...
              >
                <img src="/njsw36/static/images/icon/74.svg" alt="icon" />
              </div>
        ...
        <img
          src="/njsw36/static/images/assets/screen_03.png"
          alt="screen"
      ...
      <div className="block-style-sixteen" style={{ background: "#F9F1EF" }}>
        <div className="container">
          <div className="row">
            ...
            >
              ...
              >
                <img src="/njsw36/static/images/icon/75.svg" alt="icon" />
              </div>
        ...
        <img
          src="/njsw36/static/images/assets/screen_04.png"
          alt="screen"
